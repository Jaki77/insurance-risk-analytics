...
# Load Parquet data
data_path = r'C:\Users\jakin\Desktop\KIAM program\insurance-risk-analytics\data\insurance_data.parquet'
...
plt.tight_layout()
plt.savefig('C:/Users/jakin/Desktop/KIAM program/insurance-risk-analytics/plots/claim_frequency_province.png')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('C:/Users/jakin/Desktop/KIAM program/insurance-risk-analytics/plots/claim_severity_province.png')
plt.close()
...
if len(top_zips) == 2:
    ...
    plt.tight_layout()
    plt.savefig('C:/Users/jakin/Desktop/KIAM program/insurance-risk-analytics/plots/margin_zipcode.png')
    plt.close()

# Save report
with open('src/hypothesis_testing_report.txt', 'w') as f:
